...
import { addMonths, createMonthGrid, isoWeekNumber, monthRange } from "@/engine/calendar";
...
describe("calendar engine", () => {
  ...
  it("keeps six weeks in the correct Monday-to-Sunday columns", () => {
    const july = createMonthGrid("2026-07");
